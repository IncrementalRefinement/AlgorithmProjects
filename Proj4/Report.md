...
We use [CMake](https://cmake.org/) to control the software compilation process in this project. The "main.cpp: contains the code of Input/Output. We put the main logical of our program part inside class "HuffmanTree" within "HuffmanTree.cpp". The test code is in "test.cpp".The test case and result is in "data.csv" and "result.csv". You can also  execute task Proj4 to interactively test our program or run Proj4_test task and reproduce the test case&result if you want.
